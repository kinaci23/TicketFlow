...
namespace StajProjesi_API
{
    public partial class TicketClassifier
    {
        public const string RetrainConnectionString = @"Data Source=localhost;Initial Catalog=StajDeneme1DB;Integrated Security=True;Encrypt=False;Trust Server Certificate=True";
        public const string RetrainCommandString = @"SELECT CAST([Title] as NVARCHAR(MAX)), CAST([Description] as NVARCHAR(MAX)), CAST([FinalCategoryId] as REAL) FROM [dbo].[Tickets]";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Title",outputColumnName:@"Title")      
                                    ...
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"FinalCategoryId",inputColumnName:@"FinalCategoryId",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator: mlContext.BinaryClassification.Trainers.LbfgsLogisticRegression(new LbfgsLogisticRegressionBinaryTrainer.Options(){L1Regularization=0.03125F,L2Regularization=0.9457649F,LabelColumnName=@"FinalCategoryId",FeatureColumnName=@"Features"}), labelColumnName:@"FinalCategoryId"))      
